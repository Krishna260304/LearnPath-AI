...
const PrimaryBtn = ({ children, onClick, disabled = false }: { children: React.ReactNode; onClick?: () => void; disabled?: boolean }) => (
  <button onClick={onClick} disabled={disabled}
    className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#176b65] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#115a55] active:scale-95 disabled:cursor-not-allowed disabled:opacity-40">
    {children}
  </button>
);
